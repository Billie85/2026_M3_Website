  ...
  return (
    ...
    >
      ...
      <span className="w-6 shrink-0 relative">
        <span className="text-sm group-hover:opacity-0 transition-opacity duration-150" style={{ color: '#4889e3' }}>
          {index + 1}
        </span>
        <span className="absolute inset-0 flex items-center justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-150">
          <Play size={14} style={{ color: '#4889e3', fill: '#4889e3' }} />
        </span>
      </span>
      ...
      {/* 右矢印 */}
      <span className="text-white/20 group-hover:text-[#4889e3] group-hover:translate-x-0.5 transition-all duration-200 shrink-0">
